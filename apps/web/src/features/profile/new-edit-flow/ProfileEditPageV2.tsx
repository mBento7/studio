  ...
  return (
    <div className="max-w-2xl mx-auto py-0">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 px-2">
        ...
        >
          <a href={currentUserProfile?.username ? `/${currentUserProfile.username}` : '#'} target="_blank" rel="noopener noreferrer" aria-label="Visualizar perfil" title={currentUserProfile?.username ? undefined : 'Username não disponível'}>
