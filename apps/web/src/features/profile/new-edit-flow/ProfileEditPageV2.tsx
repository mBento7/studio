...
export default function ProfileEditPageV2({ profile, onProfileChange, onSave }: ProfileEditPageV2Props) {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      ...
      <div className="flex items-center justify-center gap-2 mb-6 overflow-x-auto scrollbar-thin scrollbar-thumb-muted/30 scrollbar-track-transparent">
        {steps.map((s, idx) => {
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <Card className="p-6 mb-6 min-h-[220px] flex flex-col justify-center">
      ...
      <div className="flex justify-between mt-8">
        <Button variant="outline" onClick={goPrev} disabled={isFirst || saving}>Voltar</Button>
        <Button onClick={isLast ? handleSave : goNext} disabled={saving}>
