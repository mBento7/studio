...
const mockPosts = [
  ...
  {
    id: '2',
    title: 'Webinar Exclusivo: Como Alavancar Sua Carreira com Whosfy',
    excerpt: 'Participe do nosso evento online e aprenda estratégias para otimizar seu perfil e encontrar oportunidades.',
    imageUrl: 'https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?w=400&h=300&fit=crop',
    author: 'Equipe Whosfy',
  ...
  {
    id: '3',
    title: 'Guia Completo: Primeiros Passos no Empreendedorismo Digital',
    excerpt: 'Tudo o que você precisa saber para iniciar sua jornada como empreendedor online, desde a ideia até a execução.',
  ...
  {
    id: '4',
    title: '10 Dicas de Performance para Desenvolvedores',
    excerpt: 'Otimize a performance do seu site com essas dicas práticas e eficazes.',
...
// Componente HeroMagazineGrid simplificado para demonstração
const HeroMagazineGrid = ({ posts }: { posts: any[] }) => {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 p-4">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-black/20 p-4 flex flex-col justify-end">
            ...
            <div className="absolute top-4 left-4">
              <span
                className={`text-xs px-2 py-1 text-white rounded-full shadow font-medium ${
                  tagColors[post.tag] || 'bg-gray-500'
                }`}
              >
                {post.tag}
              </span>
