...
const StandardSearchResultCard: React.FC<AdvancedSearchResultCardProps> = ({ user }) => {
  const backgroundStyle = user.cover_photo_url
    ? { backgroundImage: `linear-gradient(rgba(20,20,40,0.55),rgba(20,20,40,0.7)), url('${user.cover_photo_url}')`, backgroundSize: 'cover', backgroundPosition: 'center' }
...
export default StandardSearchResultCard; 