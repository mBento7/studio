...
export function UserAdExample() {
  return (
    <Card className="w-full p-1.5 shadow-lg shadow-black/5 dark:shadow-black/30 night-theme:shadow-black/50 rounded bg-card/90 border border-white/10">
      <div className="w-full bg-card rounded shadow-xl shadow-black/20 dark:shadow-black/50 night-theme:shadow-yellow-400/60 overflow-hidden border border-black/5 dark:border-white/10">
        <div className="relative">
          ...
          <div className="relative h-32 bg-gradient-to-r from-teal-600 to-cyan-600 overflow-hidden">
            <img src="https://picsum.photos/seed/useradexample/400/150" alt="TechSolutions Banner" className="w-full h-full object-cover opacity-80 user-ad-img" />
          ...
          <div className="p-4 space-y-3">
            ...
            <Button className="w-full rounded-full bg-gradient-to-r from-[#14b8a6] to-[#0e9094] hover:brightness-110 text-white font-semibold shadow-md night-theme:shadow-black/50">Ver Oferta Completa</Button>
          </div>
        </div>
      </div>
    </Card>
...
export function PremiumAdCard() {
  return (
    <div className="w-full bg-card rounded shadow-xl shadow-black/20 dark:shadow-black/50 night-theme:shadow-black/50 overflow-hidden border border-black/5 dark:border-white/10">
      <div className="relative p-6">
        ...
        <div className="space-y-3">
          ...
          <Button className="w-full rounded-full bg-gradient-to-r from-[#14b8a6] to-[#0e9094] hover:brightness-110 text-white font-semibold shadow-md night-theme:shadow-black/50">Começar Agora</Button>
        </div>
      </div>
    </div>
  );
...
export function TrendingHashtags() {
  ...
  return (
    <div className="p-4 bg-card rounded space-y-3 border border-black/5 dark:border-white/10 shadow-xl shadow-black/20 dark:shadow-black/50">
      ...
      <div className="space-y-3">
        {suggestions.map((user) => (
          <div key={user.id} className="flex items-center gap-3">
            ...
            <Button size="sm" variant="outline" className="border-[#0e9094]/50 text-[#0e9094] hover:bg-[#0e9094]/10 hover:text-[#0e9094] rounded-full night-theme:shadow-black/50">Seguir</Button>
          </div>
        ))}
      </div>
    </div>
    ...
    <div className="p-4 bg-card rounded space-y-3 border border-black/5 dark:border-white/10 shadow-xl shadow-black/20 dark:shadow-black/50">
      ...
      {coupons.map((c) => (
        <div key={c.id} className="flex justify-between items-center p-3 bg-muted/80 dark:bg-muted/30 rounded-md">
          ...
          <Button size="sm" variant="outline" className="border-[#0e9094]/50 text-[#0e9094] hover:bg-[#0e9094]/10 hover:text-[#0e9094] rounded-full night-theme:shadow-black/50">Copiar</Button>
        </div>
      ))}
    </div>
  );
